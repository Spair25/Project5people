...
btn_info = Button((66, 49, 133, 1), 260, 445, 280, 70, 'Informaion', 50, (255,255,255))
...
def inf():
    ...
    clock = time.Clock()
    font.init()
    info1 = Button((66, 49, 133, 1), 50, 100, 700, 50, "Стрілка вправо - герой йде на право", 40, (255, 255, 255))
    info2 = Button((66, 49, 133, 1), 50, 150, 700, 50, "Стрілка вліво - герой йде на ліво", 40, (255, 255, 255))
    info3 = Button((66, 49, 133, 1), 50, 200, 700, 50, "Стрілка вгору - герой стрибае, в героя є 2 стрибки", 40, (255, 255, 255))
    info4 = Button((66, 49, 133, 1), 50, 250, 700, 50, "Калвіша 'Space' - герой стріляє", 40, (255, 255, 255))
    info5 = Button((66, 49, 133, 1), 50, 300, 700, 50, "Калвіша 'E' - перехід на наступний рівень", 40, (255, 255, 255))
    info6 = Button((66, 49, 133, 1), 50, 350, 700, 50, "", 40, (255, 255, 255))
    info7 = Button((66, 49, 133, 1), 50, 400, 700, 50, "Для переходу на насупний рівень збери всі", 40, (255, 255, 255))
    info8 = Button((66, 49, 133, 1), 50, 450, 700, 50, "інгредієнти та натисни на клавішу для переходу.", 40, (255, 255, 255))
    btn_back = Button((66, 49, 133, 1), 50, 25, 100, 50, "Back", 40, (255, 255, 255))
    menu = False
    while info:
        for e in event.get():
            if e.type == QUIT:
